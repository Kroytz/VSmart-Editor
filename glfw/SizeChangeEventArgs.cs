...
namespace GLFW
{
    ...
    public class SizeChangeEventArgs : EventArgs
    {
        ...
        public SizeChangeEventArgs(int width, int height) : this(new SixLabors.ImageSharp.Size(width, height)) { }

        /// <summary>
        ///     Initializes a new instance of the <see cref="SizeChangeEventArgs" /> class.
        /// </summary>
        /// <param name="size">The new size.</param>
        public SizeChangeEventArgs(SixLabors.ImageSharp.Size size) { Size = size; }
