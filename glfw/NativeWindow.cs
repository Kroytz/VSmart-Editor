...
namespace GLFW
{
    ...
    public class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        ...
        {
            get => new SixLabors.ImageSharp.Rectangle(Position, Size);
            set
            {
                Size = value.Size;
        ...
        public SixLabors.ImageSharp.PointF ContentScale
        {
            get
            {
        ...
        /// </value>
        public SixLabors.ImageSharp.Rectangle ClientBounds
        {
            get => new SixLabors.ImageSharp.Rectangle(Position, ClientSize);
            set
            {
        ...
        /// </value>
        public SixLabors.ImageSharp.Size ClientSize
        {
            get
            {
        ...
        ///     The mouse position.
        /// </value>
        public SixLabors.ImageSharp.Point MousePosition
        {
            get
            {
                Glfw.GetCursorPosition(Window, out var x, out var y);
                return new SixLabors.ImageSharp.Point(Convert.ToInt32(x), Convert.ToInt32(y));
            }
        ...
        ///     The position.
        /// </value>
        public SixLabors.ImageSharp.Point Position
        {
            get
            {
                ...
                return new SixLabors.ImageSharp.Point(x - l, y - t);
            }
            set
            {
                Glfw.GetWindowFrameSize(Window, out var l, out var t, out var dummy1, out var dummy2);
        ...
        public SixLabors.ImageSharp.Size Size
        {
            get
            {
                ...
                return new SixLabors.ImageSharp.Size(width + l + r, height + t + b);
            }
            set
            {
                Glfw.GetWindowFrameSize(Window, out var l, out var t, out var r, out var b);
        ...
        public void CenterOnScreen()
        {
            ...
            var size = Size;
            Position = new SixLabors.ImageSharp.Point((videoMode.Width - size.Width) / 2, (videoMode.Height - size.Height) / 2);
        }
        ...
        public void SetSizeLimits(SixLabors.ImageSharp.Size minSize, SixLabors.ImageSharp.Size maxSize)
        {
        ...
        {
            FramebufferSizeChanged?.Invoke(this, new SizeChangeEventArgs(new SixLabors.ImageSharp.Size(width, height)));
        }
        ...
        {
            SizeChanged?.Invoke(this, new SizeChangeEventArgs(new SixLabors.ImageSharp.Size(width, height)));
        }
